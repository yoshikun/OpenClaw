...
当说「给 XX 加项目权限」时，以下 5 个仓库全部加 **Reporter(20)**（只读），除非主人明确要求更高级别：

| # | 仓库 | ID | 我的权限 |
|:-:|------|:--:|:--------:|
| 1 | yyzy_proj/1v1/config | 5058 | Maintainer ✅ |
| 2 | yyzy_proj/gordian/gameconfig | 4710 | Owner ✅ |
| 3 | yyzy_proj/framework/DidaFramework | 5048 | Developer ❌ 无权管理 |
| 4 | yyzy_proj/1v1/battle1v1 | 5145 | 非成员 ❌ 无权管理 |
| 5 | yyzy_proj/1v1/proto | 5060 | 非成员 ❌ 无权管理 |

> 注：仓库 3-5 需要主人先给叶枝君提升到 Maintainer 权限才能管理。

## 其他可管理的项目

| 项目 | ID | 权限 |
|------|:--:|:----:|
| yyzy/develop_client/nightoffullmoon | 2751 | Owner |
| didastudio/cdn_251121 | 5638 | Maintainer |
| yezhijun1/cdn_solo | 5871 | Owner |
